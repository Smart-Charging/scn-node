    ...
    fun postCredentials(@RequestHeader("Authorization") authorization: String,
        ...
        for (role in body.roles) {
            ...
            if (!routingService.isRoleKnownOnNetwork(basicRole)) {
                throw OcpiClientInvalidParametersException("Role with party_id=${basicRole.id} and country_code=${basicRole.country} not listed in SCN Registry with my node info!")
            }
