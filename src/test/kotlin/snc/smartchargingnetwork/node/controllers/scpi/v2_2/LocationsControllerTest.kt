...
class LocationsControllerTest(@Autowired val mockMvc: MockMvc) {
    ...
    fun `When GET sender Locations return paginated location list`() {
        ...
        responseHeaders["Link"] = "https://node.scn.co/scpi/sender/2.2/locations/page/189; rel=\"next\""
        ...
        mockMvc.perform(get("/scpi/sender/2.2/locations")
                ...
                .andExpect(header().string("Link", "https://node.scn.co/scpi/sender/2.2/locations/page/189; rel=\"next\""))
    ...
    fun `When GET sender Locations page should return proxied locations list page`() {
        ...
        val responseHeaders = HttpHeaders()
        responseHeaders["Link"] = "https://node.scn.co/scpi/sender/2.2/locations/page/68; rel=\"next\""
        ...
        mockMvc.perform(get("/scpi/sender/2.2/locations/page/${requestVariables.urlPathVariables}")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                ...
                .param("limit", "100"))
                .andExpect(status().isOk)
                .andExpect(header().string("Link", "https://node.scn.co/scpi/sender/2.2/locations/page/68; rel=\"next\""))
    ...
    fun `When GET sender Locations return single location`() {
        ...
        mockMvc.perform(get("/scpi/sender/2.2/locations/$locationID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
    ...
    fun `When GET sender Locations return single evse`() {
        ...
        mockMvc.perform(get("/scpi/sender/2.2/locations/$locationID/$evseUID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
    ...
    fun `When GET sender Locations return single connector`() {
        ...
        mockMvc.perform(get("/scpi/sender/2.2/locations/$locationID/$evseUID/$connectorID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
    ...
    fun `When GET receiver Locations return single location`() {
        ...
        mockMvc.perform(get("/scpi/receiver/2.2/locations/${sender.country}/${sender.id}/$locationID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
    ...
    fun `When GET receiver Locations return single evse`() {
        ...
        mockMvc.perform(get("/scpi/receiver/2.2/locations/${sender.country}/${sender.id}/$locationID/$evseUID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
    ...
    fun `When GET receiver Locations return single connector`() {
        ...
        mockMvc.perform(get("/scpi/receiver/2.2/locations/${sender.country}/${sender.id}/$locationID/$evseUID/$connectorID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
    ...
    @Test
    fun `When PUT receiver Locations with location body return SCPI success`() {
        ...
        mockMvc.perform(put("/scpi/receiver/2.2/locations/${sender.country}/${sender.id}/$locationID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
    ...
    @Test
    fun `When PUT receiver Locations with evse body return SCPI success`() {
        ...
        mockMvc.perform(put("/scpi/receiver/2.2/locations/${sender.country}/${sender.id}/$locationID/$evseUID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
    ...
    @Test
    fun `When PUT receiver Locations with connector body return SCPI success`() {
        ...
        mockMvc.perform(put("/scpi/receiver/2.2/locations/${sender.country}/${sender.id}/$locationID/$evseUID/$connectorID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
    ...
    @Test
    fun `When PATCH receiver Locations on location object return SCPI success`() {
        ...
        mockMvc.perform(patch("/scpi/receiver/2.2/locations/${sender.country}/${sender.id}/$locationID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
...
//
    @Test
    fun `When PATCH receiver Locations on evse object return SCPI success`() {
        ...
        mockMvc.perform(patch("/scpi/receiver/2.2/locations/${sender.country}/${sender.id}/$locationID/$evseUID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
    ...
    @Test
    fun `When PATCH receiver Locations on connector object return SCPI success`() {
        ...
        mockMvc.perform(patch("/scpi/receiver/2.2/locations/${sender.country}/${sender.id}/$locationID/$evseUID/$connectorID")
                .header("Authorization", "Token token-c")
                .header("X-Request-ID", requestVariables.headers.requestID)
                .header("X-Correlation-ID", requestVariables.headers.correlationID)
                .header("SCPI-from-country-code", sender.country)
