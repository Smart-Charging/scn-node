...
//import snc.smartchargingnetwork.node.services.HubClientInfoService
//import snc.smartchargingnetwork.node.services.RoutingService
//
//@RestController
//@RequestMapping("/scpi/2.2/hubclientinfo")
...
//                         @RequestParam("limit", required = false) limit: Int?): ScpiResponse<List<ClientInfo>> {
//
//        // TODO: add pagination
//
...
//
//        return ScpiResponse(statusCode = 1000, data = hubClientInfoService.getLocalList())
//    }
//
//
//}
