...
package snc.smartchargingnetwork.node.models.entities
...
/**
 * Stores an SCPI platform equivalent to a single SCPI connection to an SCN Node
 */
@Entity
...
class PlatformEntity(var status: ConnectionStatus = ConnectionStatus.PLANNED,
                     ...
                     @Embedded var rules: ScnRules = ScnRules(),
                     @Id @GeneratedValue var id: Long? = null)

/**
 * Tokens for authorization on SCPI party servers
...
@Embeddable
class ScnRules(@Column(columnDefinition = "boolean default false") var signatures: Boolean = false,
...
/**
 * Store a role linked to an SCPI platform (i.e. a platform can implement both EMSP and CPO roles)
 */
@Entity
@Table(name = "roles")
...
/**
 * Store endpoints associated with an SCPI platform retreived during the Versions/Credentials registration handshake
 */
@Entity
...
@Entity
@Table(name = "scn_rules_list")
class ScnRulesListEntity(
        val platformID: Long,
