...
class LocationsControllerTest(@Autowired val mockMvc: MockMvc) {
    ...
    fun `When GET sender Locations return paginated location list`() {
        ...
        responseHeaders["Link"] = "https://node.scn.co/ocpi/sender/2.2/locations/page/189; rel=\"next\""
        ...
        mockMvc.perform(get("/ocpi/sender/2.2/locations")
                ...
                .andExpect(header().string("Link", "https://node.scn.co/ocpi/sender/2.2/locations/page/189; rel=\"next\""))
    ...
    fun `When GET sender Locations page should return proxied locations list page`() {
        ...
        val responseHeaders = HttpHeaders()
        responseHeaders["Link"] = "https://node.scn.co/ocpi/sender/2.2/locations/page/68; rel=\"next\""
        ...
        mockMvc.perform(get("/ocpi/sender/2.2/locations/page/${requestVariables.urlPathVariables}")
                ...
                .param("limit", "100"))
                .andExpect(status().isOk)
                .andExpect(header().string("Link", "https://node.scn.co/ocpi/sender/2.2/locations/page/68; rel=\"next\""))
