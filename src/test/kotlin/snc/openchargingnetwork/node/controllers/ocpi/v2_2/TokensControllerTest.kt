...
class TokensControllerTest(@Autowired val mockMvc: MockMvc) {
    ...
    fun `When GET sender tokens return paginated tokens list`() {
        ...
        responseHeaders["Link"] = "https://node.scn.co/ocpi/sender/2.2/tariffs/page/935432; rel=\"next\""
        ...
        mockMvc.perform(get("/ocpi/sender/2.2/tokens")
                ...
                .andExpect(header().string("Link", "https://node.scn.co/ocpi/sender/2.2/tariffs/page/935432; rel=\"next\""))
    ...
    fun `When GET sender Tokens page should return proxied tokens list`() {
        ...
        val responseHeaders = HttpHeaders()
        responseHeaders["Link"] = "https://client.scn.co/ocpi/sender/2.2/tokens/page/935433; rel=\"next\""
        responseHeaders["X-Limit"] = "50"
        ...
        mockMvc.perform(get("/ocpi/sender/2.2/tokens/page/$uid")
                ...
                .param("limit", "100"))
                .andExpect(status().isOk)
                .andExpect(header().string("Link", "https://client.scn.co/ocpi/sender/2.2/tokens/page/935433; rel=\"next\""))
                .andExpect(header().string("X-Limit", "50"))
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
