...
package snc.smartchargingnetwork.node.controllers
...
import snc.smartchargingnetwork.node.models.scpi.RegistrationInfo
...
class AdminController(private val platformRepo: PlatformRepository,
    ...
    fun generateRegistrationToken(@RequestHeader("Authorization") authorization: String,
        ...
        val responseBody = RegistrationInfo(tokenA, urlJoin(properties.url, "/scpi/versions"))
