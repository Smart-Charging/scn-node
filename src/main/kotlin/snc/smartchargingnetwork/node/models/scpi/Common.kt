...
package snc.smartchargingnetwork.node.models.scpi
...
data class BasicRole(@JsonProperty("party_id") final val id: String,
    ...
    init {
        if (country.length != 2) {
            throw ScpiClientInvalidParametersException("Given country_code \"$country\" not 2 characters")
        }
        if (id.length != 3) {
            throw ScpiClientInvalidParametersException("Given party-id \"$id\" not 3 characters")
        }
    }
...
data class ScpiRequestVariables(@JsonProperty("module") val module: ModuleID,
                                @JsonProperty("interface_role") val interfaceRole: InterfaceRole,
                                @JsonProperty("method") val method: HttpMethod,
                                @JsonProperty("headers") val headers: ScnHeaders,
...
@JsonInclude(JsonInclude.Include.NON_NULL)
data class ScpiResponse<T>(@JsonProperty("status_code") val statusCode: Int,
                           ...
                           @JsonProperty("scn_signature") var signature: String? = null)
...
enum class ScpiStatus(val code: Int) {
    SUCCESS(1000),
    CLIENT_ERROR(2000),
