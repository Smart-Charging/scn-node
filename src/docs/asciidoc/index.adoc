...
Documentation for version 2.2 can be found on https://github.com/ocpi/ocpi[SCPI @ *GitHub*].
...
SCN Nodes provide an additional, optional SCPI module: _OcnRules_. This allows platforms to configure filtering
...
The _OcnRules_ module only specifies a receiver interface, implemented by the SCN Node itself. Connected platforms
use this interface to update rules on their given SCN Node.

==== Receiver Interface

Endpoint structure: `/ocpi/receiver/2.2/scnrules`
...
|<<scn_rules_object,OcnRules>> |1 |The requested OcnRules object.
|===
...
|create_list_type |<<scn_rules_list_type_enum,OcnRulesListType>> |yes |The type of list which the new entry applies to.
|===
...
[source]
----
POST to URL: https://node.scn.org/ocpi/receiver/2.2/scnrules/blacklist
...
|===
|Parameter |Type |Required |Description
|list_type |<<scn_rules_type_enum,OcnRulesType>> |yes |The type of rule to update.
|===
...
[source]
----
PUT to URL: https://node.scn.org/ocpi/receiver/2.2/scnrules/whitelist
...
[source]
----
PUT to URL: https://node.scn.org/ocpi/receiver/2.2/scnrules/signatures
----
...
|===
|Parameter |Type |Required |Description
|list_type |<<scn_rules_list_type_enum,OcnRulesListType>> |yes |The type of list which the new entry applies to.
...
[source]
----
DELETE to URL: https://node.scn.org/ocpi/receiver/2.2/scnrules/blacklist/NL/XYZ
----
...
|whitelist |<<scn_rules_list_class,OcnRulesList>> |1 |Whitelist rules.
|blacklist |<<scn_rules_list_class,OcnRulesList>> |1 |Blacklist rules.
|===
