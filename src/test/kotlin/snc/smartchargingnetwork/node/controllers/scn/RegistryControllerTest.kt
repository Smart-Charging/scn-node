...
class RegistryControllerTest {
    ...
    @Test
    fun getMyNodeInfo() {
        val expectedUrl = "https://node.scn.org"
        ...
        mockMvc.perform(get("/scn/registry/node-info"))
    ...
    fun getNodeOf() {
        ...
        every { registry.getOperatorByScpi(country.toByteArray(), id.toByteArray()).sendAsync().get() } returns Tuple2(expectedAddress, expectedUrl)
        mockMvc.perform(get("/scn/registry/node/$country/$id"))
                .andExpect(jsonPath("\$.url").value(expectedUrl))
